...
import brandLogo from '../../public/papygame-blue.png';
...
export default function EditorNav({ saveFunc }: EditorNavProps) {
  ...
  return (
    <Nav p={2} bg="#fafff7" justify="start">
      <Stack align="start" w="full">
        <HStack w="full">
          ...
          <ActionButton
            ...
            onClick={backAction}
            icon={<ArrowBackIcon w={6} h={6} color="#273c66" />}
          />
          <ActionButton
            label="Forward"
            disabled={hydrated ? !checkForwardAction : true}
            onClick={forwardAction}
            icon={<ArrowForwardIcon w={6} h={6} color="#273c66" />}
          />
          <ActionButton
            label="Save"
            ...
            icon={<CopyIcon w={6} h={6} color="#273c66" />}
            ...
            options={[
              {
                name: 'Save',
                shortcut: 'Ctrl+S',
                icon: <CopyIcon mr={2} color="#273c66" />,
                onClick: async () => {
                  setSaveLoading(true);
                  await saveFunc();
                  setSaveLoading(false);
              ...
              },
              {
                name: 'Export JSON',
                shortcut: '',
                icon: <ExternalLinkIcon mr={2} color="#273c66" />,
                onClick: onOpen,
              },
            ]}
          />
          <DropDown
            ...
            options={[
              {
                name: 'Run on vscode',
                icon: <ArrowRightIcon mr={2} color="#273c66" />,
                onClick: onOpenRun,
              },
            ]}
          />
          <DropDown
            ...
            options={[
              {
                name: 'Edit Flow',
                icon: <EditIcon mr={2} color="#273c66" />,
                onClick: onOpenEdit,
              },
            ]}
          />
