...
export class APIV2 {
  ...
  tagautocomplete(query?: string): Promise<AxiosResponse<AutocompleteOutput>> {
    return this.axios.get('/api/tagsearch/autocomplete' + query);
  }
...
export const API = {
  ...
  tagautocomplete: (
    ...
    return axios.get('/api/tagsearch/autocomplete?t=' + query);
  },
  getUserInfo: (): Promise<AxiosResponse<User>> => {
